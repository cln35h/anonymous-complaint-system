...
<!-- Modal Footer -->
    <div class="modal-footer">
            ...
            <input type="hidden" name="member_id" id="member_id" />
                        ...
                        <input type="submit" name="action" id="update" class="btn btn-primary" value="Add Remarks and Update Status of Complaint" />
...
<script src="temp3.js"text/javascript" language="javascript" >
